...
public class MapDemo
{
    public static void main(String[] args)
    {
        ...
        favoriteColors.put("Connor", Color.BLUE);
        favoriteColors.put("Angela", Color.PINK);

        // two different keys can have the same value
        favoriteColors.put("Rohan", Color.BLUE);

        favoriteColors.put("Roham", Color.RED);

        // but the same key cannot have two different values
        // this code changes the value for the key "Angela"
        favoriteColors.put("Angela", Color.YELLOW);
